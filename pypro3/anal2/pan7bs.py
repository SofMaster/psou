...
soup3 = BeautifulSoup(html_page3, 'lxml')    #lxml : parser(해석기)
...
print()
import re
links2 = soup3.find_all(href = re.compile(r'^https'))  # ^https : https로 시작하는 정규 표현식
print(links2)
...
print('~~~~~~~~~~~')
dd = soup4.select("div#hello > a")  # 복수 선택(직계 자식)
print(dd)
