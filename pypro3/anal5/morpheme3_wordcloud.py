...
for title in soup.find_all('p', 'tit'):
    ...
    #print(article_url)  # https://weekly.donga.com/3/search/11/3302131/1
    try:
...
# 워드클라우드 이미지 저장
pytagcloud.create_tag_image(taglist, output = 'word.png', size = (1000,600), background = (0,0,0), fontname = 'korean', rectangular = False)
