...
# 귀무 가설 : 총무부, 영업부 직원의 연봉의 평균에 차이가 없다.
# 대립 가설 : 총무부, 영업부 직원의 연봉의 평균에 차이가 있다.
try:
...
try:
    ...
    print(df1)
    print(df1['부서명' == '총무부']['연봉'])
    # avg = df1.groupby(['부서명'])['연봉'].mean()
    # print(avg) # 총무부 연봉평균 : 5414.285714, 영업부 연봉 평균 : 4908.333333
