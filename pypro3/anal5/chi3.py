...
# 교차표 사용
ctab = pd.crosstab(index = data['education'], columns = data['smoking']) # 건수
# ctab = pd.crosstab(index = data['education'], columns = data['smoking'], normalize = True)  #normailize = True : 비율
...
print(chi_result) 
#chi2, p, ddof, exp = stats.chi2_contingency(chi_result) ddof = 자유도 exp = 예측값
